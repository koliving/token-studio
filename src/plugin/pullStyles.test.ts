...
describe('pullStyles', () => {
  ...
  it('pulls text styles', async () => {
    ...
    expect(notifyStyleValuesSpy).toHaveBeenCalledWith({
      ...
      fontFamily: [
        { name: 'fontFamily.inter', type: 'fontFamily', value: 'Inter' },
        { name: 'fontFamily.roboto', type: 'fontFamily', value: 'Roboto' },
      ],
      lineHeight: [{ name: 'lineHeight.0', type: 'lineHeight', value: 'AUTO' }],
      fontWeight: [
      ...
      fontSize: [
        { name: 'fontSize.0', type: 'fontSize', value: '16' },
        { name: 'fontSize.1', type: 'fontSize', value: '24' },
      ],
